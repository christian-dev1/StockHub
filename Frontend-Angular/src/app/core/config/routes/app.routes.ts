...
export const APP_ROUTES = {
  ...
  STOCK: {
    ROOT: `/${APP_PATHS.STOCK.ROOT}`,
    ENTRY: `/${APP_PATHS.STOCK.ROOT}/${APP_PATHS.STOCK.ENTRY}`,
    EXIT: `/${APP_PATHS.STOCK.ROOT}/${APP_PATHS.STOCK.EXIT}`,
    ADJUSTMENT: `/${APP_PATHS.STOCK.ROOT}/${APP_PATHS.STOCK.ADJUSTMENT}`,
    TRANSFER: `/${APP_PATHS.STOCK.ROOT}/${APP_PATHS.STOCK.TRANSFER}`,
    MOVEMENTS: `/${APP_PATHS.STOCK.ROOT}/${APP_PATHS.STOCK.MOVEMENTS}`,
    BATCHES: `/${APP_PATHS.STOCK.ROOT}/${APP_PATHS.STOCK.BATCHES}`,
    DOCUMENTS: `/${APP_PATHS.STOCK.ROOT}/${APP_PATHS.STOCK.DOCUMENTS}`,
